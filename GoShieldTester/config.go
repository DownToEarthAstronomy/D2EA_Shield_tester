...
func loadConfig() configT {
	...
	config = configT{
		...
		scbHitPoint:            3667, // Using Corolis, enter the total in the Defense > Shield Sources > Cells green pie slice. e.g. 2 x 7A SCBs is 3621 MJ *2 = 7242 MJ
		guardianShieldHitPoint: 942,  // Using Corolis, enter the total in the Defense > Shield Sources > Shield Additions yellow pie slice. e.g. 1 x 5D GSRB = 215 MJ
